...
#include <iostream>
#include <vector>
#include<ctime>  //clockµÄÍ·ÎÄŒþ£¬srandÄÇŸäÒ²ÒªÀûÓÃÏµÍ³Ê±ÖÓ
#include<math.h>  //¿ªžùºÅ»áÓÃµœ
#include<fstream>
...
#define step 50//²œ³€ÔœÐ¡£¬ÇóœâÔœÂý
#define car_size 10
#define search_region 200  //²œ³€Ô¶ŽóÓÚËÑË÷·¶Î§£¬ÈÝÒ×ËÑË÷²»µœµã£¡
#define big_M 1000
#define max(a,b) (a >= b) ? a : b
#define min(a,b) (a <= b) ? a : b
#define random_int(a,b) (rand()%(b-a+1)+a)  //Éú³É[a,b]Ö®ŒäµÄËæ»úÕûÊý
#define random_double(a,b) (rand()/double(RAND_MAX))  //Éú³É(0,1)Ö®ŒäµÄËæ»úž¡µãÊý
/************************º¯ÊýÉùÃ÷************************/
...
#endif path_planning// !Â·Ÿ¶¹æ»®Í·ÎÄŒþ
